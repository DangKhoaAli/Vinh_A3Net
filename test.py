...
def parse_agrs():
    ...
    parser.add_argument('--load', type=str, default="/kaggle/input/models/nadkli/modelbest/pytorch/default/1/iu_xray_seed_02032026_ver2_model_best.pth", help='whether to load a pre-trained model.')
