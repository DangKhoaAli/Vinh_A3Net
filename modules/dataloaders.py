...
class R2DataLoader(DataLoader):
    ...
    def collate_fn(data):
        ...
        return images_id, images, torch.LongTensor(targets), torch.FloatTensor(targets_masks) 
            #  images: batchsize, 2,3,224,224
            #  torch.LongTensor(targets): batchsize, max_seq_length (in batch)
            #  torch.FloatTensor(targets_masks) : batchsize, max_seq_length (in batch)
